...
/**
 * ch_usb_constant.c USB descriptors and HID report descriptor of ch552 based macro keypad firmware.
 * formly USBconstant.c. from CH55xDuino generic_examples.
 */
// Device descriptor
...
// vender defined device for webhid
	0x06, HID_RAW_ID, 0xff,	// Usage Page 0xff<<8 + HID_RAW_ID
...
__code uint16_t ProductDescriptor[] = {	// Produce String Descriptor
	...
	'C','H','5','5','2',' ','n','u','m','p','a','d','2'};
	#define PRODUCT_STRING_DESCRIPTOR_DEFINED	 
#else
#ifdef CH552_MEDIAPAD
__code uint16_t ProductDescriptor[] = {	// Produce String Descriptor
	(((14 + 1) * 2) | (DTYPE_String << 8)),
	'C','H','5','5','2',' ','m','e','d','i','a','P','a','d'};
	#define PRODUCT_STRING_DESCRIPTOR_DEFINED	 
#endif
#endif
#if !defined(PRODUCT_STRING_DESCRIPTOR_DEFINED)
__code uint16_t ProductDescriptor[] = {	// Produce String Descriptor
	(((9 + 1) * 2) | (DTYPE_String << 8)),
	'C','H','5','5','2',' ','k','b','d'};
#endif
